...
@Autonomous(name = "Blue Auto Near Goal")
public  class BlueAutoNearGoal extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose( new Pose(30.75, 134, Math.toRadians(0)));
