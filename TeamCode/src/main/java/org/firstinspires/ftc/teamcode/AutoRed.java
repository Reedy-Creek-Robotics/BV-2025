...
public class AutoRed extends LinearOpMode {
    ...
    public final Pose scorePose = new Pose(60, 85, Math.toRadians(135)).mirror(); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(19.000, 84.000, Math.toRadians(180)).mirror(); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    private void buildPaths() {
        grabPickup1 = follower.pathBuilder()
                .addPath( new BezierLine(follower::getPose, new Pose(40.5, 84).mirror()))
                .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(0))
                .addPoseCallback(new Pose(40.5,84).mirror(), this::runIntake, .9)
        ...
        grabPickup2 = follower.pathBuilder()
                .addPath(new BezierLine(follower::getPose, new Pose(40.5,60).mirror()))
                .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(0))
                .addPoseCallback(new Pose(40.5,60).mirror(), this::runIntake, .9)
